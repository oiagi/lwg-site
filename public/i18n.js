  ...
  const pages = {
    ...
    '/group-courses.html': {
      ...
      text: {
        ...
        'label[for="bf-gender"]': { en: 'pronouns *', de: 'Pronomen *' },
        '#bf-gender option[value="she/her"]': { en: 'she/her', de: 'sie/ihr' },
        '#bf-gender option[value="he/him"]': { en: 'he/him', de: 'er/ihm' },
        '#bf-gender option[value="they/them"]': { en: 'they/them', de: 'they/them' },
        '#bf-gender option[value="other"]': { en: 'other', de: 'andere' },
        'label[for="bf-gender-note"]': { en: 'your pronouns *', de: 'deine Pronomen *' },
        ...
        '#err-gender': {
          en: 'Please select pronouns.',
          de: 'Bitte wähle Pronomen aus.',
        },
        '#err-gender-note': {
          en: 'Please specify your pronouns.',
          de: 'Bitte gib deine Pronomen an.',
        },
        '#err-email': {
  ...
  Object.assign(pages, {
    '/intake.html': {
      ...
      text: {
        ...
        'label[for="if-gender"]': { en: 'pronouns *', de: 'Pronomen *' },
        '#if-gender option[value="she/her"]': { en: 'she/her', de: 'sie/ihr' },
        '#if-gender option[value="he/him"]': { en: 'he/him', de: 'er/ihm' },
        '#if-gender option[value="they/them"]': { en: 'they/them', de: 'they/them' },
        '#if-gender option[value="other"]': { en: 'other', de: 'andere' },
        'label[for="if-gender-note"]': { en: 'your pronouns *', de: 'deine Pronomen *' },
