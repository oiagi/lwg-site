  ...
  const pages = {
    ...
    '/group-courses.html': {
      ...
      text: {
        ...
        'label[for="bf-gender"]': { en: 'form of address *', de: 'Anrede *' },
        '#bf-gender option[value="female"]': { en: 'female', de: 'weiblich' },
        '#bf-gender option[value="male"]': { en: 'male', de: 'männlich' },
        '#bf-gender option[value="other"]': { en: 'other', de: 'andere' },
        '#gender-disclaimer': {
          en: 'We ask this so we can address you correctly in our communication, especially formal German messages such as invoices.',
          de: 'Wir fragen das, damit wir dich in unserer Kommunikation korrekt ansprechen können, besonders in formellen deutschen Nachrichten wie Rechnungen.',
        },
        ...
        '#err-gender': {
          en: 'Please select a form of address.',
          de: 'Bitte wähle eine Anrede aus.',
        },
        '#err-gender-note': {
          en: 'Please specify your form of address.',
          de: 'Bitte gib deine gewünschte Anrede an.',
        },
        '#err-email': {
  ...
  Object.assign(pages, {
    '/intake.html': {
      ...
      text: {
        ...
        'label[for="if-gender"]': { en: 'form of address *', de: 'Anrede *' },
        '#if-gender option[value="female"]': { en: 'female', de: 'weiblich' },
        '#if-gender option[value="male"]': { en: 'male', de: 'männlich' },
        '#if-gender option[value="other"]': { en: 'other', de: 'andere' },
        '#intake-gender-disclaimer': {
          en: 'We ask this so we can address you correctly in our communication, especially formal German messages such as invoices.',
          de: 'Wir fragen das, damit wir dich in unserer Kommunikation korrekt ansprechen können, besonders in formellen deutschen Nachrichten wie Rechnungen.',
        },
