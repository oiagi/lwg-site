...
function buildCustomerEmail(course, student, language = 'en', intakeUrl = null) {
  ...
  const copy = isGerman
    ? {
        ...
        htmlLang: 'de',
        greeting: `Danke${student.first_name ? ' ' + esc(student.first_name) : ''} :)`,
        intro: 'Wir haben Ihre Buchungsanfrage erhalten. So geht es weiter:',
        stepConfirm: 'Wir bestätigen Ihre Anfrage so schnell wie möglich.',
        stepIntake:
        ...
        stepPaymentRequest: 'Sie erhalten die Zahlungsinformationen für Ihren Kurs.',
        stepPay: 'Sie bezahlen die Rechnung.',
        stepDone: 'Fertig! Ihr Platz im Kurs ist reserviert.',
        course: 'Kurs',
        starts: 'Start',
        place: 'Ort',
    ...
    : {
        ...
        htmlLang: 'en',
        greeting: `Thank you${student.first_name ? ', ' + esc(student.first_name) : ''} :)`,
