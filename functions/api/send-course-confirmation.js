...
function buildConfirmationEmail({ course, sessions, studentFirstName, language }) {
  ...
  const copy = isEnglish
    ? {
        ...
        intro: `Thank you for your registration, ${greetingName}. We look forward to learning with you soon. Below you will find all the important information about your course. Questions? Just write to us at info@learningwithgioia.ch`,
    ...
    : {
        ...
        intro: `Vielen Dank für deine Anmeldung, ${greetingName}. Wir freuen uns, bald mit dir zu lernen. Unten findest du alle wichtigen Infos zu deinem Kurs. Noch Fragen? Dann schreib uns einfach auf info@learningwithgioia.ch`,
        details: 'Kursdetails',
