...
function buildEmails(to) {
  ...
  return [
    ...
    },
    {
      ...
      html: shell(
        'Course confirmation',
        `<p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#333;">Thank you for your registration, Gioia :) We look forward to learning with you soon.</p>
        ...
        <div style="margin-top:24px;background:#fff9e6;border-left:3px solid #d4a017;padding:16px 20px;">
          ...
          <p style="margin:0;font-size:13px;line-height:1.6;color:#333;">Please cancel or postpone at least 24 hours before the lesson.</p>
        </div>`
      ),
    },
    {
